            ...
            <article className="space-y-8 dark:bg-gray-100 dark:text-gray-900">
                <div className="space-y-6">
                    ...
                    <div className="flex flex-nowrap sm:justify-start items-center dark:bg-gray-100 -mx-4 dark:text-gray-800 overflow-x-auto overflow-y-hidden">
                        ...
                        <Link to=''
                            className="flex flex-shrink-0 items-center space-x-2 dark:border-gray-600 px-5 py-3 border-b dark:text-gray-600">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4">
                                <path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"></path>
                            </svg>
                            <span>Content</span>
                        </Link>
                        <Link to={`author`} rel="noopener noreferrer" href="#"
                            className="flex flex-shrink-0 items-center space-x-2 dark:border-gray-600 px-5 py-3 border border-b-0 rounded-t-lg dark:text-gray-900">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4">
